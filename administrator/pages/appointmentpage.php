    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-white" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white active"  style="background-color: #17A2B8;" href="../pages/appointmentpage.php">
...
<tbody>
                <tr class="text-center">
                    ...
                    <?php
                    $id = $row10['doctor_id'];
                    $sql1 = "SELECT name  From administrator where id=$id";
                    ...
                    ?><td><?php echo $row->name ?></td><?php
                                        ...
                                        echo "<td>-</td>";
                                            ...
                                            ?>
                    <td><?= $row10['fname']; ?> <?= $row10['lname']; ?></td>
                    <td><?= $row10['contact']; ?></td>
                    <td><?= $row10['date']; ?></td>
                    <td><?= $row10['aboutself']; ?></td>
                    <td><?= $row10['address']; ?></td>
                    <td class="text-center"><a href="deleteappointment.php?id=<?=$row10['id'];?>" class="btn btn-danger">Delete</a></td>
                </tr>
            <?php
            }
            ?>
