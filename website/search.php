    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php">Diseases</a></li>
          <div class="mx-3">
            <form action="" method="post" class="upper_form">
              <input type="text" class="form-control" name="data" placeholder="Search your specialist...">
               <a  type="submit"  name="search" class="btn btn-info" id=""></a>
            </form>
            
          </div>
          <li class="p-1"><a class="nav-link btn btn-primary text-white p-2 m-0"href="doctor.php">Login as Doctors</a></li>
          <li class="p-1"><a class="nav-link  btn btn-warning text-white p-2 m-0"href="patient.php">Login as Patient</a></li>
        </ul>
...
<div class="container doctor-heading"></div>
      ...
      if(isset($_POST['search'])){
        $data = $_POST['data'];
        $sel = "SELECT *FROM `administrator` WHERE name='$data'";
        ...
        ?>
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="<?=$row['image'];?>" class="img-fluid" alt=""></div>
