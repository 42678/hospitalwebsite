  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-white" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="dashboard.php" target="_blank">
        <img src="../assets/img/logo-ct.png" class="navbar-brand-img h-100 text-dark" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav ">
        <li class="nav-item ">
          <a class="nav-link text-white active" style="background-color: #17A2B8;"  href="../pages/dashboard.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/tables.php">
            ...
            <span class="nav-link-text ms-1  text-dark">Doctor / Patient</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white " href="../pages/appointmentpage.php">
            <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10  text-dark">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1  text-dark">Appointments</span>
          </a>
        </li>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-12 mb-lg-0 mb-4 text-center">
              <div class="copyright text-sm text-muted ">
                ...
                <a href="" class="font-weight-bold">Chander Raja</a>
                for a better web.
              </div>
            </div>
          </div>
