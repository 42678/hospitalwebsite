...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="logout.php" class="appointment-btn scrollto"><span class="d-none d-md-inline"></span>
        LogOut</a>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>aptech latifabad, near the rooftop latifaad, hyderabad sindh pakistan</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>chander@example.com</p>
              </div>
