...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:contact@example.com">chander@example.com</a>
  ...
  $sel = "SELECT *FROM patient Where id=1";
...
?>
    <h1>Welcome <span class="text-primary"> <?php echo $_SESSION['pname'];?></span> to CARE Group</h1>
      ...
      while($row= mysqli_fetch_array($result)){
        ?>
          ...
          <div class="col-lg-4  col-md-6">
            <div class="member">
              <div class="pic rounded-3 mb-3 text-center"><img src="<?php echo $row['image']?>" class="" alt=""></div>
              <div class="member-info text-center">
                ...
                <p><?=$row['para']?></p>
                <a href="getappointment.php" class="btn btn-primary mt-3">View Details</a>
              </div>
            </div>
          </div>
...
?>
        <div class="col-lg-4 col-md-6">
        <div class="member">
          <div class="pic rounded-3 mb-3 text-center" style="overflow:visible;"><img src="<?php echo $row['image']?>" class="" width="250px" height="180px" alt=""></div>
          <div class="member-info text-center p-0">
            <a href="">
            <h4><?=$row['name']?></h4></a>
            <span><?=$row['works2']?></span>
            <p>Location: <?=$row['city']?></p>
            <p><?=$row['para']?></p>
            <a href="getappointment.php?id=<?php echo $row['id'];?>" class="btn btn-primary mt-3">View Details</a>
          </div>
        </div>
      </div>
