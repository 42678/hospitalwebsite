  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto " href="doctor.php">Home</a></li>
          ...
          <div class="img-card-container">
                  ...
                  <a class="nav-link scrollto d-inline-block active" href="doctor_profile.php"><i class="bi bi-person-circle text-primary fs-4"></i> Profile </a>
        </ul>
...
?>
				...
				<h5 class="user-name"><?=$row['name'];?></h5>
				<h6 class="user-email"><?=$row['email'];?></h6>
			</div>
			<div class="about">
				<h5 class="fs-2">About</h5>
				<p><?=$row['para'];?></p>
			</div>
		</div>
	</div>
...
<div class="card h-100">
	...
	<form class="card-body" method="post" enctype="multipart/form-data">
        ...
        <label for="">Full Name</label>
          <p class="fw-light fs-6" name="name"><?=$row['name'];?></p>
				</div>
			</div>
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
        ...
        <label for="">Email</label>
          <p class="fw-light"><?=$row['email'];?></p>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
        <label for="">City</label>
          <p class="fw-light"><?=$row['city'];?></p>
				</div>
			</div>
		...
		<div class="row gutters">
          ...
          <p class="fw-light"><?=$row['date'];?></p>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					<label for="sTate">Speciality</label>
          <p class="fw-light"><?=$row['works2'];?></p>
		...
		<div class="row gutters text-right">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
				<div class="text-right">
					<a href="updateprofile.php?id=<?=$row['id']?>" type="button" id="submit" name="submit" class="btn btn-outline-primary py-1 px-4">Update</a>
				</div>
			</div>
		</div>
